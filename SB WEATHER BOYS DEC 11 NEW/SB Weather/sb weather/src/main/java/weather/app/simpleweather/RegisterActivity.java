...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText userUName, userPassword, userEmail, userconfirmpass;
    ...
    private void setupUI(){
        ...
        userconfirmpass = (EditText) findViewById(R.id.confirm_password);
    ...
    private boolean checkInfo(){
        ...
        String checkconfirmpass = userconfirmpass.getText().toString();
        ...
        if(checkname.isEmpty() || checkpassword.isEmpty() || checkemail.isEmpty() || checkconfirmpass.isEmpty()) {
       ...
       else if(!userUName.getText().toString().matches("[a-z,A-Z]*"))
       {
        ...
        else if(!checkconfirmpass.equals(checkpassword)){
            Toast.makeText(this, R.string.conpassmsg,Toast.LENGTH_SHORT).show();
        }
